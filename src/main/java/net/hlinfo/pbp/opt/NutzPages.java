...
public class NutzPages<T> implements Serializable {
     ...
     * @param pager 分页对象
     */
    public NutzPages(List<T> list, Pager pager) {
        this.list = list;
        this.pager = pager;
    }
     ...
     * @return 当前对象,用于链式调用
     */
    public NutzPages<T> setList(List<T> list) {
        this.list = list;
        return this;
    }
     ...
     * @return 当前对象,用于链式调用
     */
    public NutzPages<T> setPager(Pager pager) {
        this.pager = pager;
        return this;
    }
}
